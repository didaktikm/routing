...
:router1 => {
        ...
        :net => [
                   {ip: '172.20.0.1', adapter: 2, netmask: "255.255.255.252", virtualbox__intnet: "web"},
                   {ip: '192.168.10.2', adapter: 3, netmask: "255.255.255.248", virtualbox__intnet: "routernet1"},
                   {ip: '192.168.20.2', adapter: 4, netmask: "255.255.255.248", virtualbox__intnet: "routernet2"},
                ]
  },
  :router2 => {
        :box_name => "centos/7",
        :net => [
                   ...
                   {ip: '10.10.0.1', adapter: 3, netmask: "255.255.255.0", virtualbox__intnet: "localnet1"},
                ]
  },
  :router3 => {
        :box_name => "centos/7",
        :net => [
                    ...
                    {ip: '10.10.1.1', adapter: 3, netmask: "255.255.255.0", virtualbox__intnet: "localnet2"},
                ]
  }
